...
{ 
    ...
    Stratified turbulence is a crucial phenomenon for mixing and tranport in
    ...
    have competing influence on the dynamics and flow structure of geophysical
    systems.
...
profile $\bar{T}(z) = z$ in the vertical direciton. 
...
\block{Stochastic Forcing}{
    ...
    \bmp{.55}
        We choose the forcing to be a vertically invariant divergence-free stochastic
        process:
        \[
        ...
        time. The image on the right shows an example of the forcing
...
\block{Vertically Averaged Quantities}{
    ...
    \bmp{.5}
        \centering
        \includegraphics[width=.95\linewidth]{images/Om2B100Re600Pe60_vert_avg.pdf}
    \emp
    \bmp{.5}
        \centering
        \includegraphics[width=.95\linewidth]{images/Om8B100Re600Pe60_vert_avg.pdf}
    \emp

    \bmp{.5}
        \centering
        \includegraphics[width=.95\linewidth]{images/Om2B30Re600Pe60_vert_avg.pdf}
    \emp
    \bmp{.5}
        \centering
        \includegraphics[width=.95\linewidth]{images/Om8B30Re600Pe60_vert_avg.pdf}
    \emp
    \end{center}
}
