...
{ 
    ...
    Jupiter's stratophere, and the solar tachocline. Rotation and stratification
...
\block{Vertically Averaged Quantities}{
    ...
    \bmp{.5}
        \centering
        \includegraphics[width=\linewidth]{images/Om2B30Re600Pe60_vert_avg.png}
    \emp
    \bmp{.5}
        \centering
        \includegraphics[width=\linewidth]{images/Om8B30Re600Pe60_vert_avg.png}
    \emp
    \end{center}
}
